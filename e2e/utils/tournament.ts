 ...
 * Marca "Torneio gratuito" pra não precisar lidar com o bloco de comprovante
 * de pagamento nos testes de inscrição.
 */
export async function createTournament(page: Page, name: string) {
  ...
  await page.getByRole('checkbox', { name: 'Torneio gratuito' }).check();
