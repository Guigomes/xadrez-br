// Aplica supabase/migrations/063_search_returns_reg_closes_flag.sql via
// conexão direta Postgres (mesmo padrão de apply-058..062.mjs).
//
// Uso:
//   SUPABASE_DB_URL="postgres://postgres:<senha>@<host>:5432/postgres" node scripts/apply-063.mjs
//
...
const sqlPath = join(__dirname, '..', 'supabase', 'migrations', '063_search_returns_reg_closes_flag.sql');
...
async function main() {
  ...
  console.log('Conectado. Aplicando 063_search_returns_reg_closes_flag.sql em uma transação…');
