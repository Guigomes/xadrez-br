...
export function ImportPairings({ slug }: { slug: string }) {
  ...
  return (
    <div className="card p-4">
      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Importar emparceiramentos</h3>
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
        Cole o link de download do Chess-Results. O número da rodada é detectado automaticamente.
      </p>
