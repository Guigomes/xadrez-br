...
// Portado de ../../cron-import/src/chess-results.ts — ver aviso de
// duplicação em process-tournament.ts.

const UA = 'Mozilla/5.0 (compatible; chess-viewer-force-import)';
 ...
 * classificação, e nenhuma rodada, sem erro nenhum.
 *
