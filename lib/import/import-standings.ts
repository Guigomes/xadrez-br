...
// Portado de ../../cron-import/src/import-standings.ts — ver aviso de
// duplicação em process-tournament.ts. Já inclui o fix de games_played/wins/
// draws/losses (antes travados em 0 pra torneio importado).
...
export async function importStandings(
  ...
  // Nome é a chave primária (mesmo padrão de import-pairings.ts),
  // initial_ranking só entra como fallback.
